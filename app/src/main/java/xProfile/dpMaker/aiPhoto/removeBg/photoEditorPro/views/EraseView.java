...
import xProfile.dpMaker.aiPhoto.removeBg.photoEditorPro.activities.EraseActivity;
...
public class EraseView extends ImageView implements OnTouchListener {
    ...
    private Paint getPaintByMode(int i, int i2, boolean z) {
        ...
        if (i == this.REDRAW) {
            ...
            this.patternBMPshader = EraseActivity.patternBMPshader;
